<?php
    ...
    */
    ...
    function sf_product_actions_price() {
    	...
    	echo '<a class="price-link" href="'.get_permalink( $product_id ).'">';
    ...
    if ( ! function_exists( 'sf_wishlist_button' ) ) {
        function sf_wishlist_button($extra_class = "") {
            ...
            if ( class_exists( 'YITH_WCWL_UI' ) ) {
				...
				$html .= '><a href="' . $url . '" rel="nofollow" data-ajaxurl="' . admin_url( 'admin-ajax.php' ). '" data-product-id="' . $product_id . '" data-product-type="' . $product_type . '" ' . $classes . ' >';
...
*/
			...
			<div class="product-price-wrap clearfix">
				...
				<?php
					if ( function_exists('wc_get_rating_html') ) {
						...
						if ( 'open' == $post->comment_status && $rating_html ) :
							echo $rating_html;
						endif;
					} else {
	...
	function sf_single_variation_add_to_cart_button() {
		...
		<div class="variations_button">
			...
			<button type="submit" data-product_id="<?php echo esc_attr($product_id); ?>" data-quantity="1" data-default_text="<?php echo esc_attr($product->single_add_to_cart_text()); ?>" data-default_icon="<?php echo $icon_class; ?>" data-loading_text="<?php echo esc_attr($loading_text); ?>" data-added_text="<?php echo esc_attr($added_text); ?>" class="single_add_to_cart_button button alt"><i class="<?php echo $icon_class; ?>"></i><span><?php echo esc_attr($product->single_add_to_cart_text()); ?></span></button>
