    ...
    if ( ! function_exists( 'sf_get_cart' ) ) {
        function sf_get_cart() {
            ...
            if ( sf_woocommerce_activated() ) {
                ...
                if ( $show_cart_count ) {
                    $cart_output .= '<li class="parent shopping-bag-item"><a class="cart-contents" href="' . wc_get_cart_url() . '" title="' . __( "View your shopping cart", "swiftframework" ) . '">'. apply_filters( 'sf_header_cart_icon', '<i class="ss-cart"></i>' ) . '<span class="cart-text">' . __( "Cart", "swiftframework" ) . '</span>' . $cart_total . '<span class="num-items cart-count-enabled">' . $cart_count_text_alt . '</span></a>';
                } else {
                    $cart_output .= '<li class="parent shopping-bag-item"><a class="cart-contents" href="' . wc_get_cart_url() . '" title="' . __( "View your shopping cart", "swiftframework" ) . '">'. apply_filters( 'sf_header_cart_icon', '<i class="ss-cart"></i>' ) . '<span class="cart-text">' . __( "Cart", "swiftframework" ) . '</span>' . $cart_total . '<span class="num-items">' . $cart_count_text_alt . '</span></a>';
                }
                ...
                if ( $cart_count != "0" ) {
                    ...
                    $cart_output .= '<a class="sf-button standard sf-icon-reveal bag-button" href="' . esc_url( wc_get_cart_url() ) . '">'.$view_cart_icon.'<span class="text">' . __( 'View cart', 'swiftframework' ) . '</span></a>';

                    $cart_output .= '<a class="sf-button standard sf-icon-reveal checkout-button" href="' . esc_url( wc_get_cart_url() ) . '">'.$checkout_icon.'<span class="text">' . __( 'Checkout', 'swiftframework' ) . '</span></a>';
