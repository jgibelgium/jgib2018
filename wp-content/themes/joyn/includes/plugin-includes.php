...
function sf_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
		    ...
		    'slug' => 'joyn-importer',
		    'source' => 'http://swiftideas.com/extras/plugins/joyn-importer.zip',
		    'required' => false,
		    'version' => '',
		...
		array(
		    'name'               => 'Master Slider',
		    'slug'               => 'masterslider',
		    'source'             => 'http://swiftideas.com/extras/plugins/masterslider.zip',
		    'required'           => false,
		    'version'            => '3.2.0',
		    'force_activation'   => false,
		    'force_deactivation' => false
		...
		array(
		    ...
		    // The plugin slug (typically the folder name)
		    'source'   				=> 'http://swiftideas.com/extras/plugins/jck-woo-quickview.zip',
		    // The plugin source
		    'required'           => false,
		    // If false, the plugin is only 'recommended' instead of required
		    'version'            => '3.4.5',
		...
		array(
		    ...
		    'slug'               => 'go_pricing',
		    // The plugin slug (typically the folder name)
		    'source'   				=> 'http://swiftideas.com/extras/plugins/go_pricing.zip',
		    // The plugin source
		    'required'           => false,
		    // If false, the plugin is only 'recommended' instead of required
		    'version'            => '3.3.8',
